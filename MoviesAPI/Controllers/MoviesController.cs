    ...
    public class MoviesController: ControllerBase
    {
        ...
        public async Task<ActionResult<MovieDTO>> Get(int id)
        {
            var movie = await context.Movies
                ...
                .Include(x => x.MovieTheatherMovies).ThenInclude(x => x.MovieTheater)
        ...
        public async Task<ActionResult<List<MovieDTO>>> Filter( [FromQuery] FilterMoviesDTO filterMoviesDTO)
        {
            ...
            await HttpContext.InsertParameteresPaginationInHeader(moviesQueryable);
        ...
        {
            var movieTheathers = await context.MovieTheaters.OrderBy(x=>x.Name).ToListAsync();
            var genres = await context.Genres.OrderBy(x => x.Name).ToListAsync();

            var movieTheatersDTO = mapper.Map<List<MovieTheaterDTO>>(movieTheathers);
        ...
        public async Task<ActionResult> Put(int id, [FromForm] MovieCreationDTO movieCreationDTO)
        {
            var movie = await context.Movies
                ...
                .Include(x => x.MovieTheatherMovies)
